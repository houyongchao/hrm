...
<body>
  	<div class="container" style="margin-top:14px;">
		<div class="row">
			<div class = "span2 well" style="margin-right:5px; margin-top:0px;">				
				<ul class="nav nav-list" style="font-size:14px; " >					 					
				  ...
				  <li class="active"><a href="${basePath }/people/ruzhirenyuan">本月入职${size }人</a></li>
			...
			<div class="span9 well" style="padding:0px;width:730px;" >
				<div>	
					<table width="100%" class="table" id="tt">
						<c:forEach items="${ruzhiList }" var="shiyong" varStatus="v">
							<tr>
								<td>${v.count }</td>
			...
			$(function(){
				$('#tt').datagrid({
					...
					columns:[[
						...
						{field:'businesssalary',title:'结果',width:20,align:'right'},
						{field:'workage',title:'批准人',width:15,align:'right'},
						{field:'workagesalary',title:'职称',width:35,align:'right'},
						{field:'extraltime',title:'联系电话',width:25,align:'right'}
					]],
